...
\begin{frame}{Introduction}
	\begin{itemize}
		\item \textbf{Reinforcement Learning (RL)} a subfield of machine learning that focuses on learning how to act in order to maximize a numerical reward signal
...
\begin{frame}[shrink=5]{Conclusion}
	...
	\begin{block}{Resources}
		\begin{itemize}
			...
			\item Multi-Agent Reinforcement Learning: \url{https://www.marl-book.com/}
		\end{itemize}
	\end{block}
\end{frame}
%/////////
